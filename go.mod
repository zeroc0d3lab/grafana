...
require (
	...
	golang.org/x/time v0.7.0 // @grafana/backend-platform
	...
	google.golang.org/api v0.205.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20241021214115-324edc3d5d38 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.20.0 // @grafana/backend-platform
