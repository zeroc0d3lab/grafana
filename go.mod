...
require (
	cloud.google.com/go/storage v1.52.0 // @grafana/backend-platform
	...
	go.opentelemetry.io/otel/sdk v1.38.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.38.0 // @grafana/backend-platform
	golang.org/x/crypto v0.45.0 // @grafana/backend-platform
	...
	golang.org/x/oauth2 v0.33.0 // @grafana/grafana-authnz-team
	...
	google.golang.org/api v0.257.0 // @grafana/backend-platform
...
require (
	...
	github.com/googleapis/gax-go/v2 v2.15.0 // @grafana/backend-platform
	...
	golang.org/x/text v0.31.0 // @grafana/backend-platform
	golang.org/x/xerrors v0.0.0-20231012003039-104605ab7028 // indirect
	google.golang.org/genproto v0.0.0-20250603155806-513f23925822 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.22.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/mod v0.29.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.38.0 // @grafana/backend-platform
