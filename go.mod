...
require (
	...
	go.opentelemetry.io/otel/sdk v1.29.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.29.0 // @grafana/backend-platform
	golang.org/x/crypto v0.27.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/text v0.18.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.29.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.28.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.23.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.29.0 // @grafana/backend-platform
