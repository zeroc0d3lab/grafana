...
require (
	...
	github.com/centrifugal/centrifuge v0.37.1 // @grafana/grafana-app-platform-squad
	...
	github.com/prometheus/client_golang v1.23.1 // @grafana/alerting-squad-backend
	github.com/prometheus/client_model v0.6.2 // @grafana/backend-platform
	github.com/prometheus/common v0.66.0 // @grafana/alerting-squad-backend
	...
	golang.org/x/crypto v0.41.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/text v0.28.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/mod v0.26.0 // @grafana/backend-platform
