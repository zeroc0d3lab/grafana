...
require (
	...
	go.opentelemetry.io/otel/sdk v1.31.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.31.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/text v0.19.0 // @grafana/backend-platform
...
require (
	...
	github.com/getkin/kin-openapi v0.124.0 // @grafana/grafana-operator-experience-squad
	...
	go.opentelemetry.io/contrib/propagators/jaeger v1.31.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.31.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.31.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.25.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.31.0 // @grafana/backend-platform
