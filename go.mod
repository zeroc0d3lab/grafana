...
require (
	...
	github.com/BurntSushi/toml v1.4.0 // @grafana/grafana-authnz-team
	...
	github.com/mattn/go-sqlite3 v1.14.22 // @grafana/backend-platform
	...
	go.opentelemetry.io/otel/sdk v1.35.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.35.0 // @grafana/backend-platform
	golang.org/x/crypto v0.37.0 // @grafana/backend-platform
...
require (
	...
	github.com/googleapis/gax-go/v2 v2.14.0 // @grafana/backend-platform
	...
	golang.org/x/text v0.24.0 // @grafana/backend-platform
	golang.org/x/xerrors v0.0.0-20240903120638-7835f813f4da // indirect
	google.golang.org/genproto v0.0.0-20241118233622-e639e219e697 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.20.1 // @grafana/backend-platform
	...
	github.com/getkin/kin-openapi v0.132.0 // @grafana/grafana-operator-experience-squad
	...
	github.com/urfave/cli v1.22.16 // @grafana/backend-platform
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.60.0 // @grafana/plugins-platform-backend
	go.opentelemetry.io/contrib/propagators/jaeger v1.35.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.35.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.35.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/mod v0.23.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.35.0 // @grafana/backend-platform
