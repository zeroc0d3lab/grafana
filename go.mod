...
require (
	...
	golang.org/x/exp v0.0.0-20231110203233-9a3e6036ecaa // @grafana/alerting-squad-backend
	...
	golang.org/x/time v0.4.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20231106174013-bbf56f31fb17 // indirect; @grafana/backend-platform
)
...
require (
	...
	github.com/docker/docker v26.1.4+incompatible // @grafana/grafana-delivery
