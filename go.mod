...
require (
	...
	golang.org/x/crypto v0.42.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/text v0.29.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/mod v0.27.0 // @grafana/backend-platform
