...
require (
	...
	go.opentelemetry.io/collector/pdata v1.40.0 // @grafana/backend-platform
	...
	go.opentelemetry.io/otel/sdk v1.37.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.37.0 // @grafana/backend-platform
	golang.org/x/crypto v0.39.0 // @grafana/backend-platform
	...
	golang.org/x/oauth2 v0.30.0 // @grafana/grafana-authnz-team
	...
	google.golang.org/grpc v1.75.0 // @grafana/plugins-platform-backend
...
require (
	...
	github.com/modern-go/reflect2 v1.0.3-0.20250322232337-35a7c28c31ee // @grafana/alerting-squad-backend
	...
	golang.org/x/text v0.26.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.46.1 // @grafana/plugins-platform-backend
...
require (
	...
	golang.org/x/mod v0.25.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.37.0 // @grafana/backend-platform
...
require go.opentelemetry.io/collector/featuregate v1.40.0 // indirect
