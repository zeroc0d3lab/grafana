...
require (
	...
	golang.org/x/net v0.48.0 // @grafana/oss-big-tent @grafana/partner-datasources
	golang.org/x/oauth2 v0.34.0 // @grafana/grafana-authnz-team
	...
	google.golang.org/api v0.258.0 // @grafana/backend-platform
