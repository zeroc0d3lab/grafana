...
require (
	cloud.google.com/go/storage v1.56.0 // @grafana/backend-platform
	...
	github.com/prometheus/client_model v0.6.2 // @grafana/backend-platform
	...
	go.opentelemetry.io/otel/sdk v1.43.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.43.0 // @grafana/backend-platform
	golang.org/x/crypto v0.50.0 // @grafana/backend-platform
	golang.org/x/exp v0.0.0-20230321023759-10a507213a29 // @grafana/alerting-squad-backend
	golang.org/x/net v0.53.0 // @grafana/oss-big-tent @grafana/partner-datasources
	golang.org/x/oauth2 v0.36.0 // @grafana/grafana-authnz-team
	golang.org/x/sync v0.20.0 // @grafana/alerting-squad-backend
	golang.org/x/time v0.15.0 // @grafana/backend-platform
	golang.org/x/tools v0.43.0 // @grafana/grafana-as-code
	gonum.org/v1/gonum v0.17.0 // @grafana/observability-metrics
	google.golang.org/api v0.277.0 // @grafana/backend-platform
...
require (
	...
	github.com/googleapis/gax-go/v2 v2.22.0 // @grafana/backend-platform
	...
	golang.org/x/text v0.36.0 // @grafana/backend-platform
	golang.org/x/xerrors v0.0.0-20231012003039-104605ab7028 // indirect
	google.golang.org/genproto v0.0.0-20260319201613-d00831a3d3e7 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.26.0 // @grafana/backend-platform
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.67.0 // @grafana/plugins-platform-backend
	go.opentelemetry.io/contrib/propagators/jaeger v1.21.1 // @grafana/backend-platform
...
require (
	...
	golang.org/x/mod v0.34.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.43.0 // @grafana/backend-platform
...
require (
	...
	github.com/go-logr/logr v1.4.3 // @grafana/grafana-app-platform-squad
