...
require (
	cloud.google.com/go/storage v1.39.1 // @grafana/backend-platform
	...
	google.golang.org/api v0.211.0 // @grafana/backend-platform
...
require (
	...
	github.com/googleapis/gax-go/v2 v2.14.1 // @grafana/backend-platform
