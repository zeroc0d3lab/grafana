...
require (
	...
	golang.org/x/crypto v0.49.0 // @grafana/backend-platform
	...
	golang.org/x/tools v0.42.0 // @grafana/grafana-as-code
	gonum.org/v1/gonum v0.17.0 // @grafana/observability-metrics
	google.golang.org/api v0.276.0 // @grafana/backend-platform
...
require (
	...
	github.com/googleapis/gax-go/v2 v2.21.0 // @grafana/backend-platform
	...
	golang.org/x/text v0.35.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/mod v0.33.0 // @grafana/backend-platform
