...
require (
	...
	go.opentelemetry.io/collector/pdata v1.37.0 // @grafana/backend-platform
	...
	go.opentelemetry.io/otel/sdk v1.36.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.36.0 // @grafana/backend-platform
	golang.org/x/crypto v0.38.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/text v0.25.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.36.0 // @grafana/backend-platform
