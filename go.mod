...
require (
	...
	go.opentelemetry.io/otel/sdk v1.33.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.33.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/propagators/jaeger v1.33.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.33.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.33.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.27.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.33.0 // @grafana/backend-platform
