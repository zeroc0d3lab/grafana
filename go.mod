...
require (
	...
	go.opentelemetry.io/collector/pdata v1.44.0 // @grafana/backend-platform
	...
	golang.org/x/crypto v0.40.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/text v0.27.0 // @grafana/backend-platform
...
require go.opentelemetry.io/collector/featuregate v1.44.0 // indirect
