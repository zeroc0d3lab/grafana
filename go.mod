...
require (
	...
	github.com/centrifugal/centrifuge v0.36.2 // @grafana/grafana-app-platform-squad
	...
	github.com/prometheus/client_golang v1.22.0 // @grafana/alerting-squad-backend
