...
require (
	...
	go.opentelemetry.io/otel/sdk v1.32.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.32.0 // @grafana/backend-platform
	golang.org/x/crypto v0.29.0 // @grafana/backend-platform
	golang.org/x/exp v0.0.0-20231006140011-7918f672742d // @grafana/alerting-squad-backend
	golang.org/x/net v0.31.0 // @grafana/oss-big-tent @grafana/partner-datasources
	golang.org/x/oauth2 v0.24.0 // @grafana/grafana-authnz-team
...
require (
	...
	golang.org/x/text v0.20.0 // @grafana/backend-platform
...
require (
	...
	github.com/getkin/kin-openapi v0.128.0 // @grafana/grafana-operator-experience-squad
	...
	go.opentelemetry.io/contrib/propagators/jaeger v1.32.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.32.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.32.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.26.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.32.0 // @grafana/backend-platform
