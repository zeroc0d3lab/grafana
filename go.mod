...
require (
	...
	github.com/grafana/grafana-plugin-sdk-go v0.268.1 // @grafana/plugins-platform-backend
	...
	go.opentelemetry.io/otel/sdk v1.34.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.34.0 // @grafana/backend-platform
	golang.org/x/crypto v0.33.0 // @grafana/backend-platform
	...
	golang.org/x/oauth2 v0.26.0 // @grafana/grafana-authnz-team
...
require (
	...
	golang.org/x/text v0.22.0 // @grafana/backend-platform
	golang.org/x/xerrors v0.0.0-20231012003039-104605ab7028 // indirect
	google.golang.org/genproto v0.0.0-20240116215550-a9fa1716bcac // indirect; @grafana/backend-platform
)
...
require (
	...
	github.com/getkin/kin-openapi v0.129.0 // @grafana/grafana-operator-experience-squad
	...
	go.opentelemetry.io/contrib/propagators/jaeger v1.34.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.34.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.34.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.28.0 // @grafana/backend-platform
	golang.org/x/mod v0.22.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.34.0 // @grafana/backend-platform
